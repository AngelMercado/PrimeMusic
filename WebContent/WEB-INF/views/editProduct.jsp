    ...
    <div class="container-wrapper" style="margin-top:3rem;">
        ...
        <form:form action="${pageContext.request.contextPath}/admin/product/editProduct" method="post" commandName="product" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<form:input path="unitStack" id="unitStack" class="form-control" value="${product.unitStack}"/>
				</div>
				<div class="form-group">
					<label for="manufacture">Manufacture</label>
					<form:input path="productManufacture" id="manufacture" class="form-control" value="${product.productManufacture}"/>
				</div>
				
        		<div class="form-group">
        			<label class="control-label" for="productImage">Upload Picture</label>
                    <form:input path="productImage" type="file" id="productImage" class="form:input-large"></form:input>
        		</div>
                <div class="form-group">
