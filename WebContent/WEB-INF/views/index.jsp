    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src='<c:url value="res/images/32.png"></c:url>' alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img class="second-slide" src="res/images/2.png" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img class="third-slide" src="res/images/35.png" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
